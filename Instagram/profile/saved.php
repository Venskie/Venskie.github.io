        ...
        <div class="content">
            ...
            <div class="posts">
                 <div class="post-header">
                    ...
                    <div class="saved active-post-header">
                        <a href="saved.php">
                ...
                <div class="save-icon">
                    <div class="circle-save"><i class="fa-regular fa-bookmark"></i></i></div>
                    <div class="save-name">Save</div>
                    <div class="save-description"><p>Save photos and videos that you want to see again. No <br> one is notified, and only you can see what you've saved.</p></div>
                </div>

...
<?php
  ...
  if (isset($_POST['submit'])&&isset($_POST['name'])&&isset($_POST['phone'])&&isset($_POST['username'])&&isset($_POST['address'])&&isset($_POST['emergency_person'])&&isset($_POST['emergency_phone'])&&isset($_POST['start'])&&isset($_POST['end'])&&isset($_POST['blood_group'])&&isset($_POST['user_group'])) {
    ...
    if(!in_array($extension, $allowed_extension)){
      ...
      $sql = "INSERT INTO `users` VALUES (NULL, '$name', '$phone', '$address', '$username', '$password', '$blood_group', '$emergency_person', '$emergency_phone', '$start', '$end', '$user_group', '$filename')";
            ...
            <form method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>" enctype="multipart/form-data">
              <div class="form-row">
                ...
                <div class="form-group col-md-12">
                  ...
                  <input type="file" accept= "image/*" class="form-control" required name="uploadfile" id="image" placeholder="image" >
                </div>
